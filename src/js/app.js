    ...
    async onWalletConnected(address, signer) {
        try {
            ...
            try {
                ...
                // Must come after the relay manager is up: the inbox's own
                // attempt, during DM startup, runs before push counts as
                // enabled. The preference is still honoured inside.
